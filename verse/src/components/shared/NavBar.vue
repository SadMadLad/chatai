...
<template>
  <header
    class="flex-center sticky top-0 z-50 bg-white bg-opacity-50 backdrop-blur-md"
  >
    <nav
      class="container mx-12 flex flex-row items-center justify-between text-sm font-semibold"
    >
