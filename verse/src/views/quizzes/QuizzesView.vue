  ...
  <section class="container">
    <div class="flex flex-col items-center sm:flex-row sm:items-start">
      <Transition name="filters">
        <QuizFiltersSidebar v-show="isFilterSidebarOpen" :are-tags-loading="areTagsLoading"
          :error-when-loading-tags="errorWhenLoadingTags" :search-params="searchParams" :tags="tags" @add-tag="addTag"
          @handle-search="handleSearch" @remove-tag="removeTag" />
      </Transition>
      <div class="@container w-full flex-grow px-8">
        <button @click="isFilterSidebarOpen = !isFilterSidebarOpen"
        ...
        <CurrentQuizFilters v-bind="currentSearchParams.search" @remove-filter="removeFilter"
        ...
        <div v-else class="@5xl:columns-4 @3xl:columns-3 @xl:columns-2 break-inside-avoid gap-4">
